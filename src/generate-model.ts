...
export function saveClass(databaseColumns: Data[], properties: Properties) {
...
public class ${properties.className} extends AbstractModel {
// TODO: constructors
${classBody}
...
`
  ...
  fs.outputFileSync(
    join(outDirPath, `${properties.fileClassName}.java`),
    classTemplate
  )
}
